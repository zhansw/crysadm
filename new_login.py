...
def get_session():
    """
    GET http://login.xunlei.com/check/?u=%B7%E5%B8%90%E5%8F%B7%2F%E6%89%8B%E6%9C%BA%E5%8F%B7%2F%E9%82%AE%E7%AE%B1&v=100 HTTP/1.1
Accept: text/html, application/xhtml+xml, */*
Referer: http://i.xunlei.com/login.html
...
Connection: Keep-Alive
    ...
    e_pwd = encrypt_password(md5(password), captcha, check_n, check_e)
    ...
    aa=s.post('http://red.xunlei.com/?r=usr/privilege')
    print(r)


def encrypt_password(md5_password, captcha, n, e):
    with PyV8.JSContext() as v8:
        v8.eval(RSAjs)
        s = v8.locals.encrypt_c(md5_password, captcha, n, e)
...
if __name__ == '__main__':
    RSAjs = """
        ...
        function encrypt_c(password,captcha, s, z) {
            var t = new RSAKey();
