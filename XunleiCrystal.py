...
def hello_world():
    ...
    s = requests.Session()
    r = s.get('https://red.xunlei.com/?r=mine/devices_stat', cookies=cookies,headers=headers)
    print(r.text)

    print(r.get('https://red.xunlei.com/?r=mine/speed_stat', cookies=cookies, headers=headers).text)
    return r.text
